    ...
    @endif
        ...
        <div class="md:col-span-2">
          <div class="px-4 p-2  sm:px-5">
            <h3 class="text-lg font-medium leading-6 text-gray-900">Add New Medication Name</h3>
          </div>
        </div>
        <div class="mt-5 md:mt-1 md:col-span-2">
          <form action="{{ route('med_name.store') }}" method="POST">
            @csrf
                                    ...
                                    <td>
                                        <div class="mt-1 flex items-center">
                                            <button title="edit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 p-3 rounded">
                                                <a href="{{ route('med_name.edit', $med_name->id) }}">
                                                    Edit
                                                </a>
                                            </button>
                                            <form action="{{ route('med_name.destroy', $med_name->id) }}" method="POST">
