        ...
        <form action="{{ route('med_category.update', $med_category->id) }}" method="POST">
            ...
            <div class='pl-1'>
                ...
                <form action="{{ route('med_category.destroy', $med_category->id) }}" method="POST">
                    ...
                    <div class='pl-3'>
                        <button class="bg-red-500 text-white active:bg-pink-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button" onclick="toggleModal('modal-id')">
                            Delete
                        </button>
                    </div>    
